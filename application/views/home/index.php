        ...
        <div id="carouselThree" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?=base_url()?>assets_web/images/slider/1.png" alt="Hero">
                        </div> <!-- slider-imgae -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?=base_url()?>assets_web/images/slider/2.png" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?=base_url()?>assets_web/images/slider/3.png" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
            </div>
                    ...
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            ...
                            <div class="features-icon">
                                ...
                                <img class="shape" src="<?=base_url()?>assets_web/images/f-shape-1.svg" alt="Shape">
                            </div>
                        </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row no-gutters grid mt-50">
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/1.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/1.png"><i class="lni lni-zoom-in"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/2.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/2.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 branding-4 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/3.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/3.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 planning-4 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/4.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/4.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/5.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/5.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/6.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/6.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/7.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/7.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/8.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/8.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets_web/images/portfolio/9.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets_web/images/portfolio/9.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets_web/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?=base_url()?>assets_web/images/basic.svg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?=base_url()?>assets_web/images/pro.svg" alt="">
                        </div>
                        <div class="pricing-header text-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?=base_url()?>assets_web/images/enterprise.svg" alt="">
                        </div>
                        <div class="pricing-header text-center">
                ...
                <div class="col-lg-5">
                    <div class="faq-content mt-45">
                        <div class="about-title">
                            ...
                            <h4 class="title">Apa yang sering orang tanyakan ? <br> tentang kita ?</h4>
                        </div> <!-- faq title -->
            ...
            <div class="row justify-content-between">
                <div class="col-xl-5 col-lg-6">
                    <div class="testimonial-left-content mt-45">
                        <h6 class="sub-title">Testimony</h6>
                        <h4 class="title">Lihat Apa Kata   <br> Pelanggan Kami</h4>
                        ...
                        <p class="text"> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Suscipit eos cupiditate voluptatum minima expedita, harum accusantium id, perferendis a aliquid ab voluptatibus voluptates. Ipsam nesciunt fuga voluptate recusandae, nihil molestias.<br> <br> ipsum ante pellentesque nisl, eget mollis turpis quam nec eros. ultricies, orci molestie blandit interdum.</p>
                ...
                <div class="col-lg-6">
                    <div class="testimonial-right-content mt-50">
                        ...
                        <div class="single-testimonial m-3">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        ...
                                        <div class="author-name media-body">
                                            ...
                                            <span class="sub-title"> <?=$t['pekerjaan']?></span>
                                        </div>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="<?=base_url()?>assets_web/images/team-3.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                            <div class="team-social">
                                <ul class="social">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-wrapper form-style-two pt-115">
                        ...
                        <form id="contact-form"  action="<?=base_url()?>home/tambah" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-input mt-25">
                                        <label>Pesan</label>
                                        <div class="input-items default">
                                            <textarea name="isi_pesan" placeholder="silahkan isi pesan anda"></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-input light-rounded-buttons mt-30">
                                        <button class="main-btn light-rounded-two tombol-kirim">Send Message</button>
                                    </div> <!-- form input -->
                                </div>
                            </div> <!-- row -->
                        </form>
